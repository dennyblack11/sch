      ...
      <div className="bg-white shadow-lg rounded-3xl overflow-hidden flex flex-col lg:flex-row w-full max-w-5xl">
        <div className="w-full lg:w-1/2 p-8 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Link to={"/login"}>
              <button className="flex items-center justify-center w-full border rounded-full py-2 px-4 text-sm md:text-base shadow-sm hover:bg-gray-50 gap-2">
                <RiAdminFill size={20} className="text-blue-600" />
